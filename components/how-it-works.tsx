...
export default function HowItWorks() {
  return (
    <div className="memorial-hiw-container max-w-[1200px] mx-auto px-5">
      <SectionHeader
        title="HOW IT WORKS"
      ...
      <div className="memorial-hiw-journey relative py-5">
        ...
        {/* Step 1 */}
        <div className="memorial-hiw-step flex mb-8 relative z-[2]">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover mr-auto relative">
            ...
            <h3 className="memorial-hiw-step-title text-gold-primary text-xl mb-4 font-semibold pl-10 relative">
              <span className="absolute left-0 top-1/2 -translate-y-1/2 w-7 h-7">
                <Image src="/images/heart.png" alt="" width={28} height={28} />
              </span>
              Choose Your Package
            </h3>
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Select between our classic or premium memorial subscription
              options, each with unique features to honor your loved one.
            </p>
          </div>
        </div>

        {/* Step 2 */}
        <div className="memorial-hiw-step flex mb-8 relative z-[2] flex-row-reverse">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover ml-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Choose the perfect format for your memorial: Autobiography,
              Biography, or Memorial page.
            </p>
          </div>
        </div>
        ...
        <div className="memorial-hiw-step flex mb-8 relative z-[2]">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover mr-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Decide whether your memorial page will be public for all to visit
              or private for invited guests only.
            </p>
          </div>
        </div>
        ...
        <div className="memorial-hiw-step flex mb-8 relative z-[2] flex-row-reverse">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover ml-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Enter information about your loved one, upload their photo, and
              create a personalized URL for their memorial.
            </p>
          </div>
        </div>
        ...
        <div className="memorial-hiw-step flex mb-8 relative z-[2]">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover mr-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Provide your details as the page creator to manage the memorial
        ...
        <div className="memorial-hiw-step flex mb-8 relative z-[2] flex-row-reverse">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover ml-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Choose from multiple secure payment options including Visa,
              Mastercard, PayPal, or Direct Debit.
            </p>
          </div>
        </div>
        ...
        <div className="memorial-hiw-step flex mb-8 relative z-[2]">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover mr-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Check your inbox for login details and important information about
              your new memorial page.
            </p>
          </div>
        </div>
        ...
        <div className="memorial-hiw-step flex mb-8 relative z-[2] flex-row-reverse">
          <div className="memorial-hiw-step-content w-[45%] bg-gradient-to-br from-white to-[#fffdf5] rounded-xl p-6 shadow-gold transition-all duration-300 hover:-translate-y-1 hover:shadow-gold-hover ml-auto relative">
            ...
            <p className="memorial-hiw-step-description text-gray-600 leading-relaxed">
              Make the memorial unique by selecting backgrounds, colors, fonts,
              and adding meaningful content.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="memorial-hiw-final-step text-center bg-gradient-to-br from-[#fffdf5] to-white p-10 rounded-2xl mt-5 relative border border-gold-primary/50 shadow-gold-final">
        ...
        <p className="memorial-hiw-final-step-description text-gray-600 leading-relaxed max-w-[700px] mx-auto">
          Invite family and friends to visit the memorial and contribute their
          own memories and tributes to create a lasting legacy.
        </p>
      </div>
    </div>
  );
